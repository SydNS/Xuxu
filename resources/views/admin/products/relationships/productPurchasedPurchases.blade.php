...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-productPurchasedPurchases">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($purchases as $key => $purchase)
                        <tr data-entry-id="{{ $purchase->id }}">
                            ...
                            <td>
                                {{ $purchase->product_purchased->description ?? '' }}
                            </td>
                            <td>
                                {{ $purchase->price ?? '' }}
                            </td>
...
@endcan
  ...
  let table = $('.datatable-productPurchasedPurchases:not(.ajaxTable)').DataTable({ buttons: dtButtons })
