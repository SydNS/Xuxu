    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sales.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_sale_price') ? 'is-invalid' : '' }}" type="number" name="total_sale_price" id="total_sale_price" value="{{ old('total_sale_price', '') }}" step="0.01">
