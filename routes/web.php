...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::post('purchases/parse-csv-import', 'PurchasesController@parseCsvImport')->name('purchases.parseCsvImport');
    Route::post('purchases/process-csv-import', 'PurchasesController@processCsvImport')->name('purchases.processCsvImport');
